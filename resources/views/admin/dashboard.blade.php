...
<div style="height:80vh; background-color: #A7946D; ">
    

          <h1 style="text-align: center; padding: 60px 0px; background-color: #A7946D;">View Customer And Services Details</h1>
<p style="padding: 10px 400px;"><a href="{{URL::to('/readCustomers')}}" style="text-decoration: none; color: #fff;"><button class="button">View</button></a></p>
<p style="padding: 10px 400px;"><a href="{{URL::to('/admin/logout')}}" style="text-decoration: none; color: #fff;"><button class="button">Logout</button></a></p>
