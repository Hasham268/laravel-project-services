...
<ul id="Home" style="position:fixed; width: 100%; top:0; overflow:hidden; z-index: 100; border: 2px solid grey;"> 
        ...
        <div class="hero-image" style="height:90vh ;">
            <div class="hero-text">
              <h1 style="font-size:50px">Web Development</h1>
          ...
          <div style="background-color: #A7946D; color: #fff; padding-bottom: 50px; padding-top: 50px;" id="Explore">
            <h1 style="text-align:center; padding: 30px 0px x0px 0px;">Web Packages</h1>
            <p style="text-align:center; padding: 30px 0px 50px 0px;">Choose our Pricing Plan
                & start your project</p>
            <div class="row">
              <div class="column">
                <div class="card" name = 'web_service' style="display: flex; box-shadow: none;">
                  <img src="#" alt="" style="width:100%">
                  @foreach ($webservices ?? '' as $webservice)
                  
                  <div class="container" style="padding: 30px 115px; box-shadow: 0 4px 8px 0 rgb(0 0 0 / 62%); margin: 8px;">
                    <h2>{{$webservice->type}}</h2>
                    <p class="title">{{$webservice->price}}</p>
                    <p style="font-size:18px ; line-height: 32px;">{{$webservice->description}}</p>
                    <p><a href="{{URL::to('/checkout', $webservice->id)}}" style="text-decoration: none; color: #fff;"><button class="button">Buy Now</button></a></p>
