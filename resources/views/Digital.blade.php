...
<ul id="Home" style="position:fixed; width: 100%; top:0; overflow:hidden; z-index: 100; border: 2px solid grey;"> 
        ...
        <div class="hero-image" style="height:90vh ;">
            <div class="hero-text">
              <h1 style="font-size:50px; line-height: 82px;">Digital Marketing</h1>
          ...
          <div style="background-color: #A7946D; color: #fff; padding-bottom: 50px; padding-top: 50px;" id="Explore">
            <h1 style="text-align:center; padding: 30px 0px x0px 0px;">Digital Marketing Packages</h1>
              ...
              <div class="column">
                <div class="card" style="display: flex; box-shadow: none;">
                  ...
                  <div class="container" style="padding: 30px 115px; box-shadow: 0 4px 8px 0 rgb(0 0 0 / 62%); margin: 8px;">
                    <h2>{{$digitalservice->type}}</h2>
                    <p class="title">{{$digitalservice->price}}</p>
                    <p style="font-size:18px ; line-height: 32px;">{{$digitalservice->description}}</p>
                    <p><a href="{{URL::to('/checkout', $digitalservice->id)}}" style="text-decoration: none; color: #fff;"><button class="button">Buy Now</button></a></p>
